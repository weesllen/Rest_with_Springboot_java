...
import com.well.demo.mapper.YmlMapper;
...
public class PersonControllerYamlTest extends com.well.demo.integrationtests.testcontainers.AbstractIntegrationTest {
				...
				.config(
						RestAssuredConfig
							...
							.encoderConfig(EncoderConfig.encoderConfig()
								.encodeContentTypeAs(
									TestsConfig.CONTENT_TYPE_YAML,
									ContentType.TEXT)))
				.basePath("/auth/signin")
					.port(TestsConfig.SERVER_PORT)
					.contentType(TestsConfig.CONTENT_TYPE_YAML)
					.accept(TestsConfig.CONTENT_TYPE_YAML)
