...
class BookServicesTest {
	...
	void testFindById() {
		...
		when(bRepository.findById(1L)).thenReturn(Optional.of(entity));
	...
	void testCreate() {
		...
		when(bRepository.save(entity)).thenReturn(persisted);
	...
	void testFindAll() {
		...
		when(bRepository.findAll()).thenReturn(list);
		
		var books = service.findAll();
		
		assertNotNull(books);
		assertEquals(14, ((List<BookVO>) books).size());
